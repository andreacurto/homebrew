...
echo ""
gum style --border "$GUM_BORDER_DOUBLE" --padding "$GUM_PADDING" --margin "$GUM_MARGIN" --foreground "$GUM_COLOR_SUCCESS" --bold "Homebrew Setup - Completato 🎉" "" "Riavvia il terminale per applicare le modifiche"
echo ""
